...
Только стандартная библиотека: urllib вместо requests, чтобы у пакета не было
ни одной зависимости из pip — всё, что нужно, есть в python3 и в GTK-стеке.

Файл дословно совпадает с версией для Windows (../winclient-python): в нём нет
ничего платформенного, и расхождение двух копий было бы хуже дублирования.
...
USER_AGENT = "CortenDeskRemote/1.0 (Linux; Python)"
